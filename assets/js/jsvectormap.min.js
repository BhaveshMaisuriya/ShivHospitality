    ...
    var T = {
            _setupContainerEvents: function () {
                ...
                this.params.draggable && (S.on(this.container, "mousemove", (function (i) {
                    ...
                    s.tooltip && s.tooltip.hide(), s._setScale(s.scale * o, n, r), t.preventDefault()
                }))
            },
            ...
            _setupContainerTouchEvents: function () {
                var t, e, i, s, a, n, r, o = this,
                    h = function (h) {
                        ...
                        if ("touchstart" == h.type && (r = 0), 1 == d.length) 1 == r && (u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, o.tooltip.hide(), o._applyTransform(), u == o.transX && p == o.transY || h.preventDefault()), i = d[0].pageX, s = d[0].pageY;
                        else if (2 == d.length)
                            if (2 == r) c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o._setScale(t * c, a, n), o.tooltip.hide(), h.preventDefault();
                            else {
